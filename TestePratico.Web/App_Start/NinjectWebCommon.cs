...
namespace TestePratico.Web.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            Fabrica.Instancia.CarregarModulos(new Ninject.Web.Mvc.MvcModule());

            var kernel = Fabrica.Instancia.Kernel;
        ...
        {
            kernel.Bind<IUnidadeTrabalho>().To<Unidade_Trabalho>().InRequestScope();
        }        
    }
}
